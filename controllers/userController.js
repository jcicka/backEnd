...
const createUser = (req, res) => {
  ...
  const sql = 'INSERT INTO users(nombre, apellido, email, password, direccion, telefono) VALUES(?,?,?,?,?,?)';
...
const updateUser = (req, res) => {
  ...
  const sql = `UPDATE users SET nombre = ?, apellido = ?, direccion = ?, telefono =? WHERE id_user = ?`;
  let data = [nombre, apellido, direccion, telefono, id];
